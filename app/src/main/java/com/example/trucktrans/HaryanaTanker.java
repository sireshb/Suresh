...
public class HaryanaTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haryana_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewhrtanker);
