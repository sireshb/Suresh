...
public class NagalandTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewnltanker);
