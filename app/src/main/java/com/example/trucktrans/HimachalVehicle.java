...
public class HimachalVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himachal_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewhpv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("HIMACHAL") || user2.getdesti2().equals("HIMACHAL")){
                        list.add(user2);
                    }
                }
