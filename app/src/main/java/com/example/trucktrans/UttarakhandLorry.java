...
public class UttarakhandLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarakhand_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewuklorry);
