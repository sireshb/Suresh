...
public class WbengalTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wbengal_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewwbtrailor);
