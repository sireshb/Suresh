...
public class ChattisgarhTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattisgarh_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewcgtanker);
