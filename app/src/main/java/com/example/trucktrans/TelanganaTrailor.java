...
public class TelanganaTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telangana_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewtstrailor);
