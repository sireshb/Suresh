...
public class KarnatakaTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karnataka_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewkatanker);
