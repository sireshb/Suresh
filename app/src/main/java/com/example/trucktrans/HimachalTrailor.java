...
public class HimachalTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himachal_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewhptrailor);
