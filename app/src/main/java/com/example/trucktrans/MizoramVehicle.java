...
public class MizoramVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mizoram_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewmrv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("MIZORAM") || user2.getdesti2().equals("MIZORAM")){
                        list.add(user2);
                    }
                }
