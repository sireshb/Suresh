...
public class HimachalContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himachal_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewhpcontainer);
