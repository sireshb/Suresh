...
public class ChattisgarhTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattisgarh_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewcgtrailor);
