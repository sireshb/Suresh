...
public class SikkimVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sikkim_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewskv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("SIKKIM") || user2.getdesti2().equals("SIKKIM")){
                        list.add(user2);
                    }
                }
