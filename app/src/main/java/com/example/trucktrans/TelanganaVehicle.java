...
public class TelanganaVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telangana_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewtsv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("TELANGANA") || user2.getdesti2().equals("TELANGANA")){
                        list.add(user2);
                    }
                }
