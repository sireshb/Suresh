...
public class TamilnaduVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamilnadu_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewtnv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("TAMILNADU") || user2.getdesti2().equals("TAMILNADU")){
                        list.add(user2);
                    }
                }
