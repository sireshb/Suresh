...
public class BhutanVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhutan_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewbhv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("BHUTAN") || user2.getdesti2().equals("BHUTAN")){
                        list.add(user2);
                    }
                }
