...
public class JharkhandContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewjrcontainer);
