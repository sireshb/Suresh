...
public class NagalandVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewnlv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("NAGALAND") || user2.getdesti2().equals("NAGALAND")){
                        list.add(user2);
                    }
                }
