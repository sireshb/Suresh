...
public class GoaTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goa_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewgatrailor);
