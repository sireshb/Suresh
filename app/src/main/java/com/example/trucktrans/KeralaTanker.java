...
public class KeralaTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kerala_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewkltanker);
