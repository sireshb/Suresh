...
public class ManipurLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manipur_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewmnlorry);
