...
public class NepalTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nepal_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewnptanker);
