...
public class MeghalayaVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meghalaya_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewmlv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("MEGHALAYA") || user2.getdesti2().equals("MEGHALAYA")){
                        list.add(user2);
                    }
                }
