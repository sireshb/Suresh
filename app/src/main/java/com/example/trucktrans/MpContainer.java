...
public class MpContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mp_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewmpcontainer);
