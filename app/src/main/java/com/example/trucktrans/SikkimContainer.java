...
public class SikkimContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sikkim_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewskcontainer);
