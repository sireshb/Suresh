...
public class SikkimTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sikkim_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewsktanker);
