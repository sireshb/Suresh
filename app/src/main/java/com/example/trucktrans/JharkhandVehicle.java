...
public class JharkhandVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewjrv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("JHARKHAND") || user2.getdesti2().equals("JHARKHAND")){
                        list.add(user2);
                    }
                }
