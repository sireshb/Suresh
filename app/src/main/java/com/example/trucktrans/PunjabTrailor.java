...
public class PunjabTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_punjab_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewpbtrailor);
