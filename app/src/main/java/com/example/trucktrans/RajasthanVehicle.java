...
public class RajasthanVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewrjv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("RAJASTHAN") || user2.getdesti2().equals("RAJASTHAN")){
                        list.add(user2);
                    }
                }
