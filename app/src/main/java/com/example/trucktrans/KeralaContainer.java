...
public class KeralaContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kerala_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewklcontainer);
