...
public class JharkhandTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewjrtrailor);
