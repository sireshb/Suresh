...
public class ManipurTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manipur_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewmntanker);
