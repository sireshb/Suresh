...
public class AssamVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assam_vehicle);


        recyclerViewv=findViewById(R.id.recycleviewasv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("ASSAM") || user2.getdesti2().equals("ASSAM")){
                        list.add(user2);
                    }
                }
