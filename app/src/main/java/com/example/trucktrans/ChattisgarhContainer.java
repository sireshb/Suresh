...
public class ChattisgarhContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattisgarh_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewcgcontainer);
