...
public class TelanganaContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telangana_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewtscontainer);
