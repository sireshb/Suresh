...
public class DelhiContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewdlcontainer);
