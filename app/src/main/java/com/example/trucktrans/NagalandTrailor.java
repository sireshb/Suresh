...
public class NagalandTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewnltrailor);
