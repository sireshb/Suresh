...
public class NepalTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nepal_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewnptrailor);
