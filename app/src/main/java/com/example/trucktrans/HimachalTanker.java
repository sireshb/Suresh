...
public class HimachalTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himachal_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewhptanker);
