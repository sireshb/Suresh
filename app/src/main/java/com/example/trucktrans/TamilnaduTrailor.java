...
public class TamilnaduTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamilnadu_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewtntrailor);
