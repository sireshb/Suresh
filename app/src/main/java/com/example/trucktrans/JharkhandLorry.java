...
public class JharkhandLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewjrlorry);
