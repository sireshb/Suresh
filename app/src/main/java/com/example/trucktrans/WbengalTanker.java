...
public class WbengalTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wbengal_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewwbtanker);
