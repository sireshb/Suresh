...
public class JkContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jk_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewjkcontainer);
