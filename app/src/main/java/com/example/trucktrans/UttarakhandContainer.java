...
public class UttarakhandContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarakhand_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewukcontainer);
