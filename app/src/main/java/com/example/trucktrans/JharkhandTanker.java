...
public class JharkhandTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jharkhand_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewjrtanker);
