...
public class AndhraVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_andhra_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewapv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("ANDHRA") || user2.getdesti2().equals("ANDHRA")){
                        list.add(user2);
                    }
                }
