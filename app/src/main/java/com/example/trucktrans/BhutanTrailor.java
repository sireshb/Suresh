...
public class BhutanTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhutan_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewbhtrailor);
