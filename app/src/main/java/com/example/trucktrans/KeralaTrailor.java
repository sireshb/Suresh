...
public class KeralaTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kerala_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewkltrailor);
