...
public class KarnatakaLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karnataka_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewkalorry);
