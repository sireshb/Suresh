...
public class GoaContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goa_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewgacontainer);
