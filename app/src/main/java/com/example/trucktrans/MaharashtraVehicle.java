...
public class MaharashtraVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maharashtra_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewmhv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("MAHARASHTRA") || user2.getdesti2().equals("MAHARASHTRA")){
                        list.add(user2);
                    }
                }
