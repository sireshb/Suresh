...
public class TelanganaLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telangana_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewtslorry);
