...
public class RajasthanTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewrjtrailor);
