...
public class NagalandLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewnllorry);
