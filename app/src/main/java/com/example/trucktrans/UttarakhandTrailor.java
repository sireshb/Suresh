...
public class UttarakhandTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarakhand_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewuktrailor);
