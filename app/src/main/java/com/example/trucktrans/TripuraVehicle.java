...
public class TripuraVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tripura_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewtrv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("TRIPURA") || user2.getdesti2().equals("TRIPURA")){
                        list.add(user2);
                    }
                }
