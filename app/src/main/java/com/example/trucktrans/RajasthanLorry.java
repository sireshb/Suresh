...
public class RajasthanLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewrjlorry);
