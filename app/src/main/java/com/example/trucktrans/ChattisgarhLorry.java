...
public class ChattisgarhLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattisgarh_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewcglorry);
