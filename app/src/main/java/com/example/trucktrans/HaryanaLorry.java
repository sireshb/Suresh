...
public class HaryanaLorry extends AppCompatActivity{
 ...
 RecyclerView recyclerViewlorry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haryana_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewhrlorry);
