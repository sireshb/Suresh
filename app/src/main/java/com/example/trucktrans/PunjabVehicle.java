...
public class PunjabVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_punjab_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewpbv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("PUNJAB") || user2.getdesti2().equals("PUNJAB")){
                        list.add(user2);
                    }
                }
