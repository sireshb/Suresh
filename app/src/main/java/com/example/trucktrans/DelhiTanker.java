...
public class DelhiTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewdltanker);
