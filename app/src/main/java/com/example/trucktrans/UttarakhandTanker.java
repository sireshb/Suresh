...
public class UttarakhandTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarakhand_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewuktanker);
