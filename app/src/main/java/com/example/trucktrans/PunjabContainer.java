...
public class PunjabContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_punjab_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewpbcontainer);
