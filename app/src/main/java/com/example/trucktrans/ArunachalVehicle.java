...
public class ArunachalVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arunachal_vehicle);
        recyclerViewv=findViewById(R.id.recycleviewarv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("ARUNACHAL") || user2.getdesti2().equals("ARUNACHAL")){
                        list.add(user2);
                    }
                }
