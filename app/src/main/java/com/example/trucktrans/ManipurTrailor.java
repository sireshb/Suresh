...
public class ManipurTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manipur_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewmntrailor);
