...
public class OdishaVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_odisha_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewodv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("ODISHA") || user2.getdesti2().equals("ODISHA")){
                        list.add(user2);
                    }
                }
