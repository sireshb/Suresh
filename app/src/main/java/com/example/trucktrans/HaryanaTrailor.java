...
public class HaryanaTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haryana_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewhrtrailor);
