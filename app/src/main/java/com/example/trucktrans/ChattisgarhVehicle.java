...
public class ChattisgarhVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chattisgarh_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewcgv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("CHATTISGARH") || user2.getdesti2().equals("CHATTISGARH")){
                        list.add(user2);
                    }
                }
