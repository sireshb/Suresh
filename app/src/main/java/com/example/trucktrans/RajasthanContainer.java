...
public class RajasthanContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewrjcontainer);
