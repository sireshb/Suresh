...
public class KarnatakaContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karnataka_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewkacontainer);
