...
public class HimachalLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_himachal_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewhplorry);
