...
public class KarnatakaTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_karnataka_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewkatrailor);
