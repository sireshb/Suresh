...
public class BhutanTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhutan_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewbhtanker);
