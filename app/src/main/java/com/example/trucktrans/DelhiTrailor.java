...
public class DelhiTrailor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi_trailor);

        recyclerViewTrailor = findViewById(R.id.recycleviewdltrailor);
