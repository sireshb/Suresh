...
public class UttarakhandVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uttarakhand_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewukv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("UTTARAKHAND") || user2.getdesti2().equals("UTTARAKHAND")){
                        list.add(user2);
                    }
                }
