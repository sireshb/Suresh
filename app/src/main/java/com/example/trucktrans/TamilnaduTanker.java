...
public class TamilnaduTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamilnadu_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewtntanker);
