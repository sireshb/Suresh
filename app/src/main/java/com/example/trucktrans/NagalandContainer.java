...
public class NagalandContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nagaland_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewnlcontainer);
