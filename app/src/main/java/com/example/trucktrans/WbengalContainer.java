...
public class WbengalContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wbengal_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewwbcontainer);
