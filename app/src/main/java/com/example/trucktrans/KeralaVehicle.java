...
public class KeralaVehicle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kerala_vehicle);

        recyclerViewv=findViewById(R.id.recycleviewklv);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    if(user2.getvstate2().equals("KERALA") || user2.getdesti2().equals("KERALA")){
                        list.add(user2);
                    }
                }
