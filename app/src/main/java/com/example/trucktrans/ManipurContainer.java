...
public class ManipurContainer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manipur_container);

        recyclerViewcontainer = findViewById(R.id.recycleviewmncontainer);
