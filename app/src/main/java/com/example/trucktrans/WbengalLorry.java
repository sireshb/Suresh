...
public class WbengalLorry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wbengal_lorry);

        recyclerViewlorry = findViewById(R.id.recycleviewwblorry);
