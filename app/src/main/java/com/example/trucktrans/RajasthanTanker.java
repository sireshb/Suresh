...
public class RajasthanTanker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rajasthan_tanker);

        recyclerViewtanker = findViewById(R.id.recycleviewrjtanker);
